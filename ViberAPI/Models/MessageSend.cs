...
namespace ViberAPI.Models
{
	public class MessageSend
	{
		...
		public static MessageSend MessageRouteNew()
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
					...
					Buttons = new List<Button>()
								{
									new Button()
									{
										Columns = 6,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Ввести новий маршрут</font></font>",
										Image = "https://viber.ars.ua/newroute.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#R0",
										BgColor = "#3E3D3C",
		...
		public static MessageSend MessageRouteNextPoint()
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
					...
					Buttons = new List<Button>()
								{
									new Button()
									{
										Columns = 6,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Наступна точка</font></font>",
										Image = "https://viber.ars.ua/nextpoint.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#NEXT",
										BgColor = "#3E3D3C",
										Silent = true
									},
									new Button()
									{
										Columns = 6,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Це була кінцева точка</font></font>",
										Image = "https://viber.ars.ua/endpoint.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#END",
										BgColor = "#3E3D3C",
		...
		public static MessageSend MessageRouteEnd()
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
					...
					Buttons = new List<Button>()
								{
									new Button()
									{
										Columns = 3,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Підтвердити</font></font>",
										Image = "https://viber.ars.ua/confirm.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#ROK",
										BgColor = "#3E3D3C",
									...
									new Button()
									{
										Columns = 3,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Відміна</font></font>",
										Image = "https://viber.ars.ua/escape.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#RESC",
										BgColor = "#3E3D3C",
										Silent = true
									}
								}
		...
		public static MessageSend MessageRouteWithoutremark()
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
					...
					Buttons = new List<Button>()
								{
									new Button()
									{
										Columns = 6,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Без примітки</font></font>",
										Image = "https://viber.ars.ua/withoutremark.png",
										TextOpacity = 0,
										ActionType = "reply",
										ActionBody = "MENU#RWR",
										BgColor = "#3E3D3C",
		...
		public static MessageSend MessageLocation(bool begin)
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
					...
					Buttons = new List<Button>()
								{
									new Button()
									{
										Columns = 6,
										Rows = 1,
										Text = "<font color=\"#FFFFFF\"><font size=\"16\">Локація</font></font>",
										Image = "https://viber.ars.ua/location.png",
										TextOpacity = 0,
										ActionType = "location-picker",
										ActionBody = (begin ? "locationBegin" : "locationNext"),
										BgColor = "#3E3D3C",
										Silent = true
									}
								}
		...
		public static MessageSend MessageLocation()
		{
			var message = new MessageSend()
			{
				min_api_version = 6,
